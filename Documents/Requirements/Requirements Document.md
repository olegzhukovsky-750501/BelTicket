...
**Требование.** Веб-приложение должно предоставить зарегистрированному пользователю интерфейс поиска доступных билетов и выбора параметров поиска, таких как источник, пункт назначения, дата поездки, тип поездки: в одну сторону или две, а также отобразить информацию о билетах: наименование перевозчика, станция отправления, станция прибытия, время отправления, время прибытия, время пути, тип автобуса, количество свободных мест и стоимость билета.

<a name="booking"/>

#### 3.1.6 Бронирование билетов

**Требование.** Веб-приложение должно предоставить зарегистрированному пользователю интерфейс бронирования билета на автобус, т.е. возможность выбрать номер места, имя и фамилию пассажира, адрес электронной почты, номер телефона, номер паспорта и номер платежной карты, а также вывести итоговою сумму за билеты.
